...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user) {
        $error = "Username ou Email já estão cadastrados.";
    } else {

        $stmt = $pdo->prepare('INSERT INTO users (username, email, password, game_points) VALUES (:username, :email, :password, 0)');
...
<body>
    ...
    <div id="overlay">
        <div id="formContainer">
            ...
            <p class="redirect-button" onclick="window.location.href='/login'">Já tem conta? Faça login</p>
        </div>
